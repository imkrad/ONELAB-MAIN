                ...
                <BCol lg="6" class="mt-1 mb-1">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <b-button @click="openAdd(96,'Sample Type')" style="margin-top: 20px;" variant="light" class="waves-effect waves-light ms-1" :disabled="(form.laboratory_type) ? false : true"><i class="ri-add-circle-fill"></i></b-button>
                        </div>
                    </div>
                </BCol>
                <BCol lg="6" class="mt-1 mb-1">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <b-button @click="openAdd(97,'Test Name')" style="margin-top: 20px;" variant="light" class="waves-effect waves-light ms-1" :disabled="(form.laboratory_type) ? false : true"><i class="ri-add-circle-fill"></i></b-button>
                        </div>
                    </div>
                </BCol>
            </BRow>
        ...
        <BRow>
            ...
            <BCol lg="12" class="mt-0">
                    ...
                    <div class="input-group mb-1">
                        ...
                        <b-button @click="openMethod()" type="button" variant="primary">
...
export default {
    ...
    methods: { 
        ...
        submit(){
            if(this.editable){
                this.form.put('/services/testservices/update',{
                    preserveScroll: true,
                    onSuccess: (response) => {
                        this.hide();
                    }
